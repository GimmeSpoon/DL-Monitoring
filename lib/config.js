...
const config = {
	...
	storageRoots: ['/home'],           // du scan roots; each top-level dir = one account
	storageScanSudo: false,            // prefix repquota/du with `sudo -n` (needs passwordless sudo)
	storageScanIntervalMs: 6 * 3600 * 1000,
	storageScanTimeoutMs: 300000,      // cap a single server's du walk
	...
	serviceListPath: path.join(ROOT, 'services.json'),
...
module.exports = { config, loadServerList, loadServiceList, loadAppConfig, saveAppConfig };
